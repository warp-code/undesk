  ...
  it("successfully cranks a fully-filled deal", async () => {
    ...
    await program.methods
      .crankDeal(
        ...
        new anchor.BN(deserializeLE(crankBalanceBlobNonce).toString())
      )
      .accountsPartial({
    ...
    // ==========================================
    // STEP 6: Verify DealSettled event
    // ==========================================
    ...
    // ==========================================
    // STEP 7: Verify DealAccount state
    // ==========================================
